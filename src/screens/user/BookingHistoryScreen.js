        ...
        <View style={styles.actionsRow}>
          ...
          {statusText === 'Active' && (
            <TouchableOpacity 
              ...
              onPress={() => navigation.navigate('Checkout', { bookingId: item.id })}
            >
              <Icon name="exit-to-app" size={20} color="#4CAF50" />
              <Text style={[styles.actionText, { color: '#4CAF50' }]}>Checkout</Text>
            </TouchableOpacity>
          )}
